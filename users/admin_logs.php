		...
		<div class="row">
			<div class="col-xs-12">
				...
				<table id="paginate" class='table table-hover table-list-search'>
					<thead>
						<th>ID</th><th>Data</th><th>Tipo</th><th>User</th><th>Evento</th>
					</thead>
					<tbody>
		  ...
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title">Filtrar usu�rior</h4>
		      </div>
		      <div class="modal-body">
				...
				<div class="btn-group pull-right"><input class='btn btn-primary' type='submit' value='Filtrar' class='submit' /></div><br />
				</form>
				</div>
		      </div>
