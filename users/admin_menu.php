...
<div class="row">
	...
	<p class="text-center">
	<a href="admin_menu.php?menu_title=<?=$menu_title?>&action=newDropdown" class="btn btn-primary" role="button">Novo Dropdown</a>
	<a href="admin_menu.php?menu_title=<?=$menu_title?>&action=newItem" class="btn btn-primary" role="button">Novo Item</a>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-hover table-condensed">
			<thead><tr><th>ID</th><th>Label</th><th>Parent</th><th>Link*</th><th>Dropdown*</th><th>Grupos</th><th>Logged In*</th><th>Ordem de exibição*</th><th>Icon Class*</th><th>Action</th></tr>*Click para editar</thead>
			<tbody>
			<?php
			$i=0;
			...
			?>
				...
				<td><p class="oce" data-id="<?=$item->id?>" data-field="dropdown" data-input="select"><?=($item->dropdown) ? 'Sim' : 'Não';?></p></td>
				<td>
				<?php
				$sep = '';
				...
				<td><p class="oce" data-id="<?=$item->id?>" data-field="logged_in" data-input="select"><?=($item->logged_in) ? 'Sim' : 'Não';?></p></td>
