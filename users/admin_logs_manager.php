	...
	<?=resultBlock($errors,$successes);?>
		<div class="row">
			<div class="page-wrapper">
				...
				<h1>Gerência de Logs<a class="nounderline" href="admin_logs_manager.php"><i class="fa fa-fw fa-refresh"></i></a> <a class="nounderline" href="admin_logs.php"><i class="fa fa-fw fa-search"></i></a></h1>
        <hr>
					<center>
					<div>
							...
							<tr>
							<tr>
								<th><center>Tipo do Log</center></th>
								<th><center>Contador</center></th>
								<th><center>Isento de culpa?</center></th>
								<th><center>Função Mapeada</center></th>
							</tr>
					 <?php
					if($count > 0)
					{
						foreach ($query->results() as $row){ ?>
								 <tr>
									...
									<td><center><a href="#" data-name="exempt" id="exempt" data-value="<?=$exp?>" class="exempt nounderline" data-mode="popup" data-type="select" data-pk="<?=$row->logtype;?>" data-url="admin_logs_exempt.php" data-title="Isentar a responsabilidade para <?=$row->logtype;?>?"><?php if($exempt->count() > 0) {?>Sim<?php } else {?> Não<?php } ?></a></center></td>
									<td><center><a href="#" data-name="mapper" id="mapper" class="mapper nounderline" data-mode="popup" data-type="select" data-pk="<?=$row->logtype;?>" data-url="admin_logs_mapper.php" data-title="Escolha um motivo mapeado <?=$row->logtype;?> as?">Map</a></center></td>
								</tr><?php
					} }
					else
					 { ?>
						 <tr><td colspan='4'><center>Sem Logs</center></td></tr>
					 <?php }
					 ?>
					 </table>
					</div>
