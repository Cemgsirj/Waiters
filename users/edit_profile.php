		 ...
		 <div class="container">
				...
				<div class="well">
					<div class="row">
						...
						<h1>Perfil de <?=echouser($user->data()->id)?></h1>

          <form name="update_bio" action="edit_profile.php" method="post">
    <div align="center"><textarea rows="20" cols="80"  id="mytextarea" name="bio" lang="pt-br"><?=$thisProfile->bio;?></textarea></div>
          <input type="hidden" name="csrf" value="<?=Token::generate();?>" >
		</p>
		  <p>
			<button type="submit" class="btn btn-primary" name="update_bio">Atualizar Bio</button>
			<a class="btn btn-info" href="profile.php?id=<?php echo $userID;?>">Cancelar</a>
