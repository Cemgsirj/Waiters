...
?>
    ...
    <h2 class="form-signin-heading"></i><p><?=lang("SIGNIN_TITLE","");?></p></h2>
    <input type="hidden" name="dest" value="<?= $dest ?>" />

    <div class="form-group">
        <label for="username" >Usuario ou e-mail</label>
  ...
  <?php } ?>
    ...
    <div class="form-group">
    <label for="remember">
    <input type="checkbox" name="remember" id="remember" > Manter logado</label>
    </div>
...
<div class="row">
    <div class="col-xs-6"><br>
        <a class="pull-left" href='forgot_password.php'><i class="fa fa-wrench"></i> Esqueci a senha!</a><br><br>
    </div>
    <div class="col-xs-6"><br>
