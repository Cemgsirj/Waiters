...
$lang = array_merge($lang,array(
	"AB_SETSAVED"      => "Ajustes salvos com sucesso",
	"AB_PATHCREATE"    => "Caminho criado.",
	"AB_PATHERROR"     => "Não foi possível criar o caminho.",
	"AB_PATHEXISTED"   => "Destination path already existed. Using the existing folder.",
	"AB_BACKUPSUCCESS" => "Backup OK.",
	"AB_BACKUPFAIL"    => "Backup falhou.",
	"AB_DB_FILES_ZIP"  => "DB &amp; compactado.",
	"AB_FILE_RENAMED"  => "Arquivo renomeado para:&nbsp;",
	"AB_NOT_RENAME"    => "Não foi possível renomear o arquivo.",
	"AB_ERROR_CREATE"  => "Erro ao criar o arquivo zipado",
	"AB_DB_ZIPPED"     => "Database compactado",
	"AB_PATHEXIST"     => "Backup path already exists or could not be created.",
	"AB_T_FILE_ZIP"    => "Arquivos do framework compactados",
	"AB_TABLES_ZIP"    => "Tabelas compactadas",
	"AB_BACKUP_DELETE" => "Backup(s) excluidos!",
	"AB_PAGENAME"      => "Backup do sistema",
	"AB_BACKUP_SET"    => "Ajustes de Backup",
	"AB_BACKUP_DEST"   => "Destino de Backup",
	"AB_BACKUP_DEST_INFO" => "Relativo ao arquivo z_us_root.php. Coloque a / para root.",
	"AB_BACKUP_SOURCE" => "Origem do Backup",
	"AB_DB_TM_FILES"   => "Database &amp; arquivos do framework",
	"AB_DB_FILES"      => "Database apenas",
	"AB_TM_FILES"      => "Apenas arquivos do framework",
	"AB_SINGLE_TBL"    => "Tabela única",
	"AB_SELECT_TBL"    => "Selecionar tabela",
	"AB_DB_TBLS"       => "DB Tabelas",
	"AB_SAVE_SETTINGS" => "&nbsp;Salvar ajustes&nbsp;",
	"AB_BACKUP_BTN"    => "&nbsp;Backup&nbsp;",
	"AB_EXIST_BACKUP"  => "Backups existente&nbsp;",
	"AB_DATE"          => "Data",
	"AB_BACKUP_FILE"   => "Backup arquivo",
	"AB_FILE_SIZE"     => "Tamanho do arquivo",
	"AB_ACTIONS"       => "Ações",
	"AB_DELETE_B"      => "&nbsp;Delete Backup&nbsp;",
	"AB_BACKUP_NOT"    => "Backup(s) não apagados!",
	"WENT_WRONG" 	   => "Algo deu errado",
	"AB_DB_ALL_FILES"  => "Database &amp; ALL Files (Experimental)",
	"AB_SAVE_WARNING"  => "Salve os ajustes antes de afetuar o backup."
	));
