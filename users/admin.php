...
if($pwWarning == 1 && !$local){ ?>
	<div class="alert alert-danger">
	  <strong>Atenção!</strong> Por favor mude a senha do administrador clicando no link abaixo.
	</div>
<?php } ?>

<?php if($vcWarning == 1){ ?>
	<div class="alert alert-danger">
	  <strong>Atenção!</strong> Seu vericode é inseguro. Execute <a href="update.php">update.php</a> para corrigir.
	</div>
<?php } ?>

<?php if($recapWarning == 1 && !$local){ ?>
	<div class="alert alert-danger">
	  <strong>Atenção!</strong> Você está usando reCaptcha. Troque pela sua KEY antes de ativar o site.
	</div>
<?php } ?>
        <h1 class="text-center">Versão do Dashboard: <?=$user_spice_ver?></h1>
        <div class="row row-centered">

			<a href="<?=$us_url_root?>users/check_updates.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
                <div class="panel panel-default">
                    <i class="fa fa-arrow-up fa-2x"></i><br>Verificar<br>Atualizações</li>
                </div>
            </div></a>

			<a href="<?=$us_url_root?>users/admin_backup.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
                <div class="panel panel-default">
                    <i class="fa fa-floppy-o fa-2x"></i><br>Fazer<br>Backup</li>
                </div>
            </div></a>

			<a href="<?=$us_url_root?>users/cron_manager.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
                <div class="panel panel-default">
                    <i class="fa fa-server fa-2x"></i><br>Gerenciar<br>Cron Jobs</li>
                </div>
            </div></a>
      ...
      <a href="<?=$us_url_root?>users/admin_notifications.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
                <div class="panel panel-default">
                    <i class="fa fa-bell fa-2x"></i><br>Gerenciar<br>Notificações</li>
                </div>
            </div></a>
      <?php } ?>
			...
			<a href="<?=$us_url_root?>users/admin_logs.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
                <div class="panel panel-default">
                    <i class="fa fa-area-chart fa-2x"></i><br>Gerenciar<br>System Logs</li>
                </div>
            </div></a>

			<a href="<?=$us_url_root?>users/admin_messages.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
                <div class="panel panel-default">
                    <i class="fa fa-comment fa-2x"></i><br>Gerenciar<br>Menssagens</li>
                </div>
            </div></a>
		...
		<div class="col-md-12 col-xs-6">
			<div class="panel with-nav-tabs panel-default">
				<div class="panel-heading">
					...
					<li <?php if($tab == 1 || $tab == ''){echo "class='active'";} ?>><a href="#tab1default" data-toggle="tab">Statisticas</a></li>
						<li <?php if($tab == 2){echo "class='active'";}?>><a href="#tab2default" data-toggle="tab">Ajustes do Site</a></li>
						<li <?php if($tab == 3){echo "class='active'";}?>><a href="#tab3default" data-toggle="tab">Registros</a></li>
						<li <?php if($tab == 4){echo "class='active'";}?>><a href="#tab4default" data-toggle="tab">Social Logins</a></li>
						<li <?php if($tab == 5){echo "class='active'";}?>><a href="#tab5default" data-toggle="tab">Ajustes de CSS</a></li>
						<li <?php if($tab == 6){echo "class='active'";}?>><a href="#tab6default" data-toggle="tab">Exemplos de CSS</a></li>
          <?php
            if($settings->custom_settings == 1){ ?>
            <li <?php if($tab == 7){echo "class='active'";}?>><a href="#tab7default" data-toggle="tab">Ajustes pessais</a></li>
          <?php } ?>
					</ul>
				</div>
