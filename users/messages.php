                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="row" id="maindiv">
                        <div>
                          <h1><?php if (checkMenu(2,$user->data()->id)){  ?><div class="btn-group pull-left"><button type="button" helptext="Nova mensagem em massa para todos os usuários" class="btn btn-info" data-toggle="modal" data-target="#composemass"><i class="glyphicon glyphicon-plus"></i> Nova Massiva</button></div><?php } ?> <center>Conversas <a href="#" data-toggle="modal" class="nounderline" data-target="#settings"><i class="glyphicon glyphicon-cog"></i></a> <div class="btn-group pull-right"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#compose"><i class="glyphicon glyphicon-plus"></i> Nova mensagem</button></div></center></h1>
                        </div>
                        <?php if($count > 0) {?><label><input type="checkbox" class="checkAllMsg" />
                          [ Selecionar tudo ]</label><?php } ?>
                                  ...
                                  <?php if($count > 0) {?>
                                    <?php foreach($messages as $m){
                                      ...
                                      if($difference >= 0 && $difference < 7) {
                                        ...
                                        if($today==$last_message) { $last_update = "Hoje, "; $last_update .= date("H:i:s",$lastmessage); }
                                        else {
                                          $last_update = date("d/n/Y H:i:s",$lastmessage); } }
                                          elseif($difference >= 7) { $last_update = date("d/n/Y H:i:s",$lastmessage); }
                                          ...
                                          <td class="pull-left">
                                            <h4>
                                              ...
                                              <a class="nounderline" href="message.php?id=<?=$m->id?>">
                                                Atualizado <?=$last_update?> por <?php echouser($m->last_update_by);?>
                                              </a>
                                            </tr>
                                          <?php } } else {?>
                                            <td colspan="2"><center><h3>Sem conversas</h3></center></td></tr>
                                          <?php } ?>
                                        </tbody>
                                      </table></center>
                                      <input type="hidden" name="csrf" value="<?=$csrf?>" />
                                      <?php if($count > 0) {?><div class="btn-group pull-right"><input class='btn btn-danger' type='submit' name='Submit' value='Arquivar' /></div><?php } ?>
                                    </form>
                                    <br /><?php if($archiveCount > 0) {?><center><a href="#" data-toggle="modal" data-target="#archived">Ver mensagens arquivadas</a></center><?php } ?>
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Ajustes de mensagens</h4>
                                      </div>
                                      <div class="modal-body">
                                        <form class="form" id="messageSettings" name='messageSettings' action='messages.php' method='post'>
                                          <p><strong>Habilita/desabilita funções</strong></p>
                                          <center>
                                            <div class="checkbox <?php if($settings->msg_notification==0) {?> disabled<?php } ?>">
                                              <label>
                                                <input type="checkbox" <?php if($settings->msg_notification==0) {?> disabled<?php } ?> data-toggle="toggle" data-onstyle="info" data-offstyle="danger" name="msg_notification" id="msg_notification" <?php if($user->data()->msg_notification==1) {?>checked <?php } ?> value="Sim">
                                                Avisar por e-mail
                                              </label>
                                            </div>
                                          </div>
                                          <div class="modal-footer">
                                            <div class="btn-group">
                                              <input type="hidden" name="csrf" value="<?=$csrf?>" />
                                              <input class='btn btn-primary' type='submit' name="messageSettings" value='Atualiza' class='submit' /></div>
                                            </form>
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                              <div class="btn-group">
                                                <input class='btn btn-primary' type='submit' name="send_message" value='Envia mensagem' class='submit' /></div>
                                              </form>
                                              <div class="btn-group"><button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button></div>
                                            </div>
                                          </div>
                                      ...
                                      <div id="archived" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                          ...
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                                              <h4 class="modal-title">Mensagens arquivadas</h4>
                                            </div>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                          ...
                                                          <?php foreach($messages2 as $m2){ ?>
                                                            ...
                                                            if($difference >= 0 && $difference < 7) {
                                                              ...
                                                              if($today==$last_message) { $last_update = "hoje, "; $last_update .= date("H:i:s",$lastmessage); }
                                                                ...
                                                                $last_update = date("d/m/Y H:i:s",$lastmessage); } }
                                                                elseif($difference >= 7) { $last_update = date("d/m/Y H:i:s",$lastmessage); }
                                                                ...
                                                                <td class="pull-left">
                                                                  <h4>
                                                                    ...
                                                                    <a class="nounderline" href="message.php?id=<?=$m2->id?>">
                                                                      <?=$m2->msg_subject?> - com <?php if($m2->msg_from == $user->data()->id) { echouser($m2->msg_to); } else { echouser($m2->msg_from); } ?>
                                                                    </a>
                                                                  </h4>
                                                                  <a class="nounderline" href="message.php?id=<?=$m2->id?>">
                                                                    Atualizado <?=$last_update?> por <?php echouser($m2->last_update_by);?>
                                                                  </a>
                                                                </tr>
                                                              <?php } } else {?>
                                                                <td colspan="2"><center><h3>Sem mensagens arquivadas</h3></center></td></tr>
                                                              <?php } ?>
                                                            </tbody>
                                                          </table></center>
                                                          <br />
                                                        ...
                                                        <div class="modal-footer">
                                                          <div class="btn-group">
                                                            <input type="hidden" name="csrf" value="<?=$csrf?>" />
                                                            <input class='btn btn-primary' type='submit' name="delete" value='Apagar' class='submit' /></div>
                                                            <div class="btn-group"><input class='btn btn-primary' type='submit' name="unarchive" value='Desarquivar selecionadas' class='submit' /></div>
                                                          </form>
                                                          <div class="btn-group"><button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button></div>
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          <form name="create_mass_message" action="messages.php" method="post">
                                                            ...
                                                            <label><input type="checkbox" name="sendEmail" id="sendEmail" checked /> Enviar por notificação por e-mail?</label>
                                                            <input type="hidden" name="csrf" value="<?=$csrf?>" />
                                                          </p>
                                                          <p>
                                                            <br />
