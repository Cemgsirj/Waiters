...
<?php } ?>
                ...
                <label for="confirm">Termos e condições de uso do site</label>
        ...
        <button class="submit btn btn-primary " type="submit" id="next_button"><i class="fa fa-plus-square"></i> Registrar</button>
</form><br />
</div>
</div>
