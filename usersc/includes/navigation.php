...
<div class="collapse navbar-collapse navbar-top-menu-collapse navbar-left"> <!-- Left navigation items -->
	<ul class="nav navbar-nav ">
        ...
        <li><a class="nav-link js-scroll-trigger fa fa-find" href="#Descubra">Descubra</a></li>
        <!--li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#portfolio">Portfolio</a>
        </li-->
        <li><a class="nav-link js-scroll-trigger fa fa-about" href="#Sobre">Sobre</a></li>
        <li><a class="nav-link js-scroll-trigger fa fa-team" href="#Equipe">Equipe</a></li>
